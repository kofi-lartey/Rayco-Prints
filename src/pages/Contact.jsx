...
const Contact = () => {
    ...
    return (
        <div className="min-h-screen pt-20">
            {/* Header */}
            <section className="py-16 bg-gradient-to-br from-royal-50 to-slate-50">
                            ...
                            <div className="space-y-6 mb-8">
                                {contactInfo.map((info, index) => (
                                    <div key={index} className="flex items-start space-x-4">
                                        <div className="w-12 h-12 bg-rayco-forest/10 rounded-xl flex items-center justify-center text-rayco-forest shrink-0">
                                            {info.icon}
                                        </div>
                                        <div>
